...
func TestGetBlockWithRealFile(t *testing.T) {
	...
	hashes := [][]byte{
		{235, 203, 167, 177, 114, 56, 226, 172, 6, 254, 96, 77, 68, 107, 80, 141, 148, 248, 180, 189},
		{199, 10, 10, 118, 99, 244, 176, 96, 247, 53, 217, 230, 10, 42, 50, 233, 147, 116, 217, 141},
	}
...
func TestFileStoreWithMultipleFiles(t *testing.T) {
	...
	hashes := [][]byte{
		{73, 34, 176, 29, 229, 125, 157, 28, 41, 61, 161, 34, 149, 47, 162, 50, 32, 142, 179, 113},
		{253, 88, 132, 30, 179, 131, 129, 178, 163, 242, 219, 174, 160, 79, 92, 251, 81, 103, 81, 153},
		{103, 128, 108, 125, 224, 90, 210, 85, 56, 27, 112, 170, 148, 114, 155, 39, 132, 132, 67, 148},
		{207, 35, 173, 86, 79, 73, 78, 120, 174, 37, 56, 240, 209, 56, 179, 35, 216, 183, 95, 250},
		{234, 216, 33, 126, 28, 215, 199, 57, 176, 132, 212, 140, 74, 106, 140, 205, 81, 39, 183, 54},
		{81, 45, 79, 164, 142, 254, 170, 73, 121, 139, 104, 80, 249, 172, 251, 139, 232, 73, 69, 143},
	}
